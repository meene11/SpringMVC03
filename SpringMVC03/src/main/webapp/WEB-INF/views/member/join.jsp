...
<head>
  ...
  <script type = "text/javascript">
	    ...
	    function goInsert(){
	    	...
	    	document.frm.submit(); // 전송 frm -> form의 name
	    }
	</script>
...
<div class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">회워가입</div>
    	...
    	<form name="frm" action="${contextPath}/memRegister.do" method="post">
    		...
    		<table class="table table-boredered" style="text-align: center; border: 1px solid #ddd;">
    			...
    			<tr>
    				...
    				<td colspan="2">
    					<div class="form-group" style="text-aligh: center; maring: 0 auto;">
    			...
    			<tr>
    				...
    				<td colspan="2"><input id="memEmail" name="memEmail" class="form-control" type="text" maxlength="20" placeholder="이메일를 입력하세요."/></td>
    			</tr>
