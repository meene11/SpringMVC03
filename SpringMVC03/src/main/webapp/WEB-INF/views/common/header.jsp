	      ...
	      <ul class="nav navbar-nav navbar-right">
            ...
            <c:if test="${mvo.memProfile eq ''}">
            	<li style="color:#9d9d9d;">
					<img class="img-circle" alt="기본이미지" src="${contextPath}/resources/images/person.PNG" style="width:50px; height:50px" /> ${mvo.memName}님 Welcome
				</li>
			</c:if>
			
			<c:if test="${mvo.memProfile ne ''}">
				<li style="color:#9d9d9d;">
					<img class="img-circle" alt="회원이미지" src="${contextPath}/resources/upload/${mvo.memProfile}" style="width:50px; height:50px" /> ${mvo.memName}님 Welcome
				</li>
			</c:if>
